                    ...
                    <TouchableWithoutFeedback onPress={() => {}}>
                        ...
                        <View style={[style.modalView]}>
                                ...
                                <View style={styles.sliderHeader}>
                                    <Title style={{ fontFamily: Fonts.primaryBold, fontSize:16 , color:Colors.blackColor }}>
                                        {title}
                                    </Title>
                                    <Button 
                                        labelStyle={{
...

                                {
                                    ...
                                    <View style={{flexDirection:'row' , justifyContent:'center' , marginTop: mode === "time" ? 15:0 }}>

                                        <TimePicker title="Start Time" initHour={startHour} initMin={startMin} initAP="" 
                                        ...
                                        <TimePicker title="End Time" initHour={ endHour } initMin={  endMin } initAP=""  
                                        onChanged={(hour, min, ap) => {
                                            setEndHour(hour);
                                            setEndMin( min );
                                            setEndTime(hour + ":" + min );
