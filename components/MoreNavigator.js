...
export default function RepMoreScreen(props) {
  ...
  return (
    <Stack.Navigator>
      ...
      {selectProject == 'geo_rep' &&
        componentListOne.includes('content_library') && (
      ...
      {selectProject == 'geo_rep' &&
        componentListOne.includes('product_sales') && (
          <Stack.Screen name="ProductSales" options={{ header: () => null }}>
            {props => (
              <ProductSalesScreen {...props} screenProps={navigation} />
            )}
          </Stack.Screen>
        )}
      {selectProject == 'geo_rep' &&
        componentListOne.includes('notifications') && (
          <Stack.Screen name="Notifications" options={{ header: () => null }}>
            {props => (
              <NotificationsScreen {...props} screenProps={navigation} />
            )}
          </Stack.Screen>
        )}
      {selectProject == 'geo_rep' && componentListOne.includes('messages') && (
      ...
      {selectProject == 'geo_rep' &&
        componentListOne.includes('recorded_sales') && (
          <Stack.Screen name="RecordedSales" options={{ header: () => null }}>
            {props => (
              <RecordedSalesScreen {...props} screenProps={navigation} />
            )}
          </Stack.Screen>
        )}
      {selectProject == 'geo_rep' &&
      ...
      {selectProject == 'geo_rep' && componentListOne.includes('stock_module') && (
      ...
      {selectProject == 'geo_crm' &&
        componentListThree.includes('content_library') && (
      ...
      {selectProject == 'geo_crm' &&
        componentListThree.includes('crm_locations') && (
          <Stack.Screen name="CRMLocations" options={{ header: () => null }}>
            {props => (
              <CRMLocationsScreen {...props} screenProps={navigation} />
            )}
          </Stack.Screen>
        )}
      {selectProject == 'geo_crm' &&
        componentListThree.includes('sales_pipeline') && (
      ...
      {selectProject == 'geo_life' &&
        componentListTwo.includes('content_library') && (
          <Stack.Screen
