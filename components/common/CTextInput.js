...
const CTextInput = props => {
  const {multiline, cTextRef, dynamicFieldRef, index, add_prefix, add_suffix} =
    props;
    ...
    <View style={{alignSelf: 'stretch'}}>
      <View
        ...
        {add_prefix != undefined && add_prefix !== '' && (
          <Text style={styles.prefixContainer}> {add_prefix} </Text>
        )}

        {props.label && props.label != '' && renderTopDescription(props.label)}
        ...
        <TextInput
          ...
          {...props}
          style={[
            multiline ? styles.multilineTextInput : styles.textInput,
            props.textInputStyle,
            {marginLeft: getPrefixPadding()},
          ]}
          onSubmitEditing={() => {
            if (
              dynamicFieldRef != undefined &&
        ...
        {add_suffix != undefined && add_suffix !== '' && (
          <Text style={styles.suffixContainer}> {add_suffix} </Text>
        )}
      </View>
