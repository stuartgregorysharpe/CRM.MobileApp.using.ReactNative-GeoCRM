...
const Learning = `<svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M11.7949 7.44554L19.5385 4.54125C20.1538 4.33003 20.1538 3.43234 19.5385 3.22112L11.7949 0.316832C10.6154 -0.105611 9.38462 -0.105611 8.20513 0.316832L0.461538 3.22112C-0.153846 3.43234 -0.153846 4.33003 0.461538 4.54125L8.20513 7.44554C9.38462 7.86799 10.6154 7.86799 11.7949 7.44554Z" fill="${actionIconBackground}"/>
<path d="M16.1025 13.9406L13.7436 15.1023C11.3846 16.264 8.66663 16.264 6.30765 15.1023L3.94868 13.9406C2.87176 13.4126 2.15381 12.3036 2.15381 11.0363V7.868C2.15381 7.49837 2.51278 7.28715 2.82048 7.39276L8.15381 9.39936C9.38458 9.8746 10.7179 9.8746 11.9487 9.39936L17.2307 7.39276C17.5384 7.28715 17.8974 7.49837 17.8974 7.868V11.0363C17.8974 12.3036 17.1794 13.4126 16.1025 13.9406Z" fill="#F6267D"/>
</svg>`;
...
export default ({
  ...
  <Fragment>
    ...
    {icon == 'Round_Btn_Default_Dark_Gray' && (
      <SvgXml
        style={style}
        xml={Round_Btn_Default_Dark_Gray}
        width={width}
        height={height}
      />
    )}
    ...
    {icon == 'Scan_Icon_Gray' && (
      <SvgXml style={style} xml={Scan_Icon_Gray} width={width} height={height} />
    )}
    ...
    {icon == 'Sales_Cart_Gray' && (
      <SvgXml style={style} xml={Sales_Cart_Gray} width={width} height={height} />
    )}
    ...
    {icon == 'Inactive_Repeat' && (
      <SvgXml style={style} xml={Inactive_Repeat} width={width} height={height} />
    )}
    ...
    {icon == 'Career' && (
      <SvgXml style={style} xml={Career} width={width} height={height} />
    )}
    {icon == 'Danger' && (
      <SvgXml style={style} xml={Danger} width={width} height={height} />
    )}
    {icon == 'Fraud' && (
      <SvgXml
        style={style}
    ...
    {icon == 'Health_Safety' && (
      <SvgXml style={style} xml={Health_Safety} width={width} height={height} />
    )}
    {icon == 'Info' && (
      <SvgXml style={style} xml={Info} width={width} height={height} />
    )}
    {icon == 'Learning' && (
      <SvgXml
        style={style}
    ...
    {icon == 'Marketing' && (
      <SvgXml style={style} xml={Marketing} width={width} height={height} />
    )}
    {icon == 'News' && (
      <SvgXml style={style} xml={News} width={width} height={height} />
    )}
    {icon == 'Notify' && (
      <SvgXml style={style} xml={Notify} width={width} height={height} />
    )}
    {icon == 'Office' && (
      <SvgXml style={style} xml={Office} width={width} height={height} />
    )}

    {icon == 'Sales' && (
      <SvgXml style={style} xml={Sales} width={width} height={height} />
    )}
    {icon == 'Shield_Fail' && (
      <SvgXml style={style} xml={Shield_Fail} width={width} height={height} />
    )}
    {icon == 'Star' && (
      <SvgXml
        style={style}
    ...
    {icon == 'Survey' && (
      <SvgXml style={style} xml={Survey} width={width} height={height} />
    )}
