...
const StartEndDateSelectionModal = ({visible, title, startDate, endDate,  openDatePicker, onModalClose }) => {
    return (
        <Modal 
            animationType="slide"
            transparent={true}
            ...
            <View style={{flex:1, flexDirection:'column'}}>
                ...
                <View style={{marginTop:20}}>
                    ...
                    <TouchableOpacity onPress={() => {
                        ...
                        <View style={styles.rowContainer}>
                            <Text style={styles.hintStyle}>{startDate !==  "" ? startDate : 'Select Start Date' }</Text>
                ...
                <View style={{marginTop:20}}>
                    ...
                    <TouchableOpacity onPress={() => {
                        ...
                        <View style={styles.rowContainer}>
                            <Text style={styles.hintStyle}>{endDate !== "" ? endDate : 'Select End Date' }</Text>
                            <SvgIcon icon="Angle_Left" width='20px' height='20px' />
                        </View>
                    </TouchableOpacity>
                </View>
