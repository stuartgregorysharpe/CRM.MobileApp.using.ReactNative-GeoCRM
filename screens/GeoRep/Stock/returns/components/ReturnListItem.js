...
export default function ReturnListItem({item}) {
  return (    
    <View style={{marginHorizontal:15}}>
        <View style={{flexDirection:'row' , marginTop:15, marginBottom:3, justifyContent:'center', alignItems:'center'}}>
            <View style={{flex:3}}>
                ...
                <AppText type="secondaryMedium" title={item.serial} color={Colors.disabledColor}  style={{fontSize:10.4}} ></AppText>
            </View>
            <View style={{flex:2}}>
                <AppText type="secondaryMedium" title={item.reason} color={Colors.disabledColor} style={{fontSize:10.4}}></AppText>
            </View>
