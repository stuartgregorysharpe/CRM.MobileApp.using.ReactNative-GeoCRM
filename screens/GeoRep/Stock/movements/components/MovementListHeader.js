...
export default function MovementListHeader() {
  ...
  return (    
    <View style={{marginHorizontal:15}}>
        <View style={{flexDirection:'row' , marginTop:15, marginBottom:3, justifyContent:'center', alignItems:'center'}}>
            ...
            <View style={{flex:2}}>
                <AppText type="secondaryMedium" title={"Action"} color={whiteLabel().mainText} style={{fontSize:12}}></AppText>
            </View>
            <View style={{flex:2}}>
                <AppText type="secondaryMedium" title={"Type"} color={whiteLabel().mainText} style={{fontSize:12}}></AppText>
            </View>
            <View style={{flex:2, alignItems:'flex-end'}}>
                <AppText type="secondaryMedium" title={"Date"} color={whiteLabel().mainText} style={{fontSize:12}}></AppText>
            </View>
        </View>
