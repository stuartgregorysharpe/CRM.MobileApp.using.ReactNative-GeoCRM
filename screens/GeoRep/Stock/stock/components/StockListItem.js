    ...
    <View style={{marginHorizontal:15}}>
        <View style={{flexDirection:'row' , marginTop:15, marginBottom:3, justifyContent:'center', alignItems:'center'}}>
            <View style={{flex:3}}>
                ...
                <AppText type="secondaryMedium" title={item.stock_type === "Consumables" ? item.qty :  item.serial } color={Colors.disabledColor}  style={{fontSize:10.4}} ></AppText>
            </View>
            <View style={{flex:2}}>
                <AppText type="secondaryMedium" title={item.stock_type} color={Colors.disabledColor} style={{fontSize:10.4}}></AppText>
            </View>
            <View  style={{flex:2, alignItems:'flex-end'}}>
                <AppText type="secondaryMedium" title={item.added_date} color={Colors.disabledColor} style={{fontSize:10.4}}></AppText>
            </View>
        </View>
