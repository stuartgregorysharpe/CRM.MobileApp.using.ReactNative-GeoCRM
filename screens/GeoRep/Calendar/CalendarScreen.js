...
import { SafeAreaView, Text, View, StyleSheet, TouchableOpacity, FlatList, SectionList } from 'react-native';
        ...
        <View style={{ flex: 1 }}>
          {
            ...
            <SectionList
              ...
              renderSectionHeader={({ section }) => {
                console.log(section);
                return <Text style={[styles.itemTitle, { textDecorationLine: 'underline', fontWeight: '700' }]}>{moment(section.title).format('dddd DD MMM YYYY')}</Text>
              }}
            />
          }
          {
