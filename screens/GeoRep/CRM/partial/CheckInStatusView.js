...
export default function CheckInStatusView({specificLocationId , onGo , page}) {

    //const { specificLocationId , onGo }  = {props};
  ...
  return (
    <View>
      <TouchableWithoutFeedback onPress={() => { 
            ...
            <View style={[styles.checkinBubble , {marginBottom: page === "map" ? 50: 150}]}>                                          
