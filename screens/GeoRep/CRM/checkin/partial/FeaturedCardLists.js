...
export default function FeaturedCardLists(props) {
    ...
    const loadFeatureCards = async () => { 
        ...
        const customer_and_contacts =  features.includes("customer_and_contacts") ? true: false;
        const location_specific_forms =  features.includes("location_specific_forms") ? true: false; 
